...
[E1, E2] = findEpipolarLines(points_3D, vue4, points_2D_right, vue2, points_2D_left);
...
for i = 1:1:12
    ...
    abc = E2(:,i);
    vue2_epipolar_line_x = linspace(0, 2000, 100);
    vue2_epipolar_line_y = (-abc(1)*vue2_epipolar_line_x - abc(3))/abc(2);
...
for i = 1:1:12
    ...
    %through two given points
    def = E1(:,i);
    vue4_epipolar_line_x = linspace(0, 2000, 100);
    vue4_epipolar_line_y = (-def(1)*vue4_epipolar_line_x - def(3))/def(2);
